...
Else
  ...
  Response.Write("<div class='col-sm-4'>")
   ...
   response.write("<img class='card-img-top' src='"& objRS.Fields("path").value &"'>")  
   response.write("<div class='card-body h-100'>")
   response.write("<h5 class='card-title'>" & objRS.Fields("adi").value & "</h5>")
   response.write("<p>Ürün ID = " & objRS.Fields("id").value & "</p>")
   response.write("<p class='price'>" & objRS.Fields("fiyat").value & " TL</p>")
